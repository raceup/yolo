    ...
    private void showWheelTemperatureChartPanel() {
        if (tyre.getTyreData(WHEEL_TEMPERATURE) != null) {
            Timer updater = new Timer(REFRESH_RATE, e -> {
                ...
                */
                //test code
                wheelTemperatureChartPanel.updateSeriesOrFail(0, ThreadLocalRandom.current().nextInt(20, 100));
                wheelTemperatureChartPanel.updateSeriesOrFail(1, ThreadLocalRandom.current().nextInt(20, 100));
                wheelTemperatureChartPanel.updateSeriesOrFail(2, ThreadLocalRandom.current().nextInt(20, 100));
                wheelTemperatureChartPanel.updateSeriesOrFail(3, ThreadLocalRandom.current().nextInt(20, 100));
